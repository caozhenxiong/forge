...
class SyntaxRepairSupportTests {
    ...
    void modelSyntaxRepairRunsWhenDeterministicRepairCannotFix() {
        ...
        SyntaxRepairSupport repairSupport = repairSupport(new devflow.agent.testsupport.RequestBackedLlmProvider() {
            @Override
    ...
    private static final class NoOpRepairProvider extends devflow.agent.testsupport.RequestBackedLlmProvider {
