 ...
 */
class HtmlFocusedRegionResolver {

    private final TreeSitterSupport treeSitterSupport;

    HtmlFocusedRegionResolver(TreeSitterSupport treeSitterSupport) {
        this.treeSitterSupport = treeSitterSupport;
    }

    HtmlEditRegion resolvePrimaryRegion(String htmlSource) {
     ...
     */
    HtmlEditRegion resolvePreferredRegion(String htmlSource, HtmlEditRegion preferredRegion) {
    ...
    boolean hasEditableRegion(String htmlSource, HtmlEditRegion region) {
        if (region == null) {
            return false;
        }
        HtmlEditableStructure structure = treeSitterSupport.inspectEditableHtml(htmlSource);
