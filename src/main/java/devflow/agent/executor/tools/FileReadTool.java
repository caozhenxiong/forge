...
public final class FileReadTool implements ImplementationTool {
    ...
    public ToolInvocationResult invoke(LlmToolCall toolCall, ToolExecutionContext context) {
        try {
            ...
            ToolExecutionContext.ToolReadState existingState = context.readState(absolutePath);
            ...
            context.rememberReadState(absolutePath, new ToolExecutionContext.ToolReadState(
