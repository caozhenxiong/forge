 ...
 */
public final class ImplementationJavascriptBehaviorScanner {
    ...
    public ImplementationJavascriptBehaviorScanner(ImplementationBodyNormalizer bodyNormalizer) {
    ...
    public List<ImplementationCompletenessFinding> scan(String source) {
