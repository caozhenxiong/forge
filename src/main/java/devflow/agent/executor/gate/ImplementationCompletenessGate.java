 ...
 * 而是统一走 gate 输出。
 */
public class ImplementationCompletenessGate {
    ...
    public ImplementationCompletenessGate(ImplementationCompletenessCheck completenessCheck) {
        this.completenessCheck = completenessCheck;
    }

    public ImplementationCompletenessGateOutcome evaluate(ImplementationCompletenessGateInput input) {
        if (input == null) {
    ...
    public ReviewResult toBlockingReviewResult(ImplementationCompletenessGateOutcome outcome, DocumentLanguage language) {
