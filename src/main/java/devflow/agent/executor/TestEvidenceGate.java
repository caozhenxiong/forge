 ...
 */
class TestEvidenceGate implements DeterministicGate<TestEvidenceGateInput> {

    TestEvidenceGateOutcome evaluateDetailed(TestEvidenceGateInput input, DocumentLanguage language) {
