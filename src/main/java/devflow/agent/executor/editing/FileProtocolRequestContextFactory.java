 ...
 */
public final class FileProtocolRequestContextFactory {

    private final FileScopedContextSupport fileScopedContextSupport;

    public FileProtocolRequestContextFactory(FileScopedContextSupport fileScopedContextSupport) {
        this.fileScopedContextSupport = fileScopedContextSupport;
    }

    public FileProtocolRequestContext hostHtml(TaskPackage taskPackage) {
