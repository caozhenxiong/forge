 ...
 */
public class HtmlInlineStyleWorkingSetResolver {

    private final TreeSitterSupport treeSitterSupport;
    private final TargetLocator targetLocator;

    public HtmlInlineStyleWorkingSetResolver(TreeSitterSupport treeSitterSupport, TargetLocator targetLocator) {
        this.treeSitterSupport = treeSitterSupport;
        this.targetLocator = targetLocator;
    }

    public InlineStyleWorkingSet resolve(Path htmlPath, String htmlSource) {
