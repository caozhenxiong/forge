...
public class EditUnitPlanner {
    ...
    public List<EditUnit> planCodeUnits(Path relativePath, String source) {
        return batchCodeSymbols(relativePath, source, EditUnitKind.CODE_SYMBOL_BATCH, relativePath + "#code-unit");
    }

    public PatchPlan planCodePatch(Path relativePath, String source) {
        return new PatchPlan(relativePath, FileEditStrategyNames.PRECISE_CODE, planCodeUnits(relativePath, source));
    }

    public List<EditUnit> planInlineScriptUnits(Path syntheticPath, String source) {
    ...
    public PatchPlan planInlineScriptPatch(Path syntheticPath, String source) {
