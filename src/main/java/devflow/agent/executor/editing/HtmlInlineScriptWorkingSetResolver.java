 ...
 */
public class HtmlInlineScriptWorkingSetResolver {

    private final TreeSitterSupport treeSitterSupport;
    private final TargetLocator targetLocator;

    public HtmlInlineScriptWorkingSetResolver(TreeSitterSupport treeSitterSupport, TargetLocator targetLocator) {
        this.treeSitterSupport = treeSitterSupport;
        this.targetLocator = targetLocator;
    }

    public InlineScriptWorkingSet resolve(Path htmlPath, String htmlSource) {
