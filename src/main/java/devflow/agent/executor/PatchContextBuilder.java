...
final class PatchContextBuilder {
    ...
    List<String> relevantInlineScriptSymbols(Path hostRelativePath, String scriptContent) {
    ...
    List<String> relevantInlineStyleSymbols(Path hostRelativePath, String styleContent) {
    ...
    int topLevelCodeSymbolCount(Path relativePath, String source) {
