 ...
 */
public class ImplementationContextResolver {
    ...
    public ImplementationContextResolver(
    ...
    public ImplementationExecutionContext resolve(
            Path projectPath,
            RunRecord runRecord,
            String analysis,
            String prd,
        ...
        DocumentLanguage language = languagePolicy.resolve(runRecord.goal(), runRecord.constraints(), note);
