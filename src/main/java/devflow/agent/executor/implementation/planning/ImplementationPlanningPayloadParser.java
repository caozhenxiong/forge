 ...
 */
public final class ImplementationPlanningPayloadParser {
    ...
    public ImplementationPlanningPayloadParser(
    ...
    public ParseResult<ImplementationOutline> parseOutline(
            String response,
    ...
    public ParseResult<ImplementationSubtaskDetail> parseSubtaskDetail(
            String subtaskId,
            String response,
            ImplementationEventJournal eventJournal,
            int attempt
