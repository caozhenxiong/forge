 ...
 */
public class ImplementationEventJournal {
    ...
    public ImplementationEventJournal(
    ...
    public List<ImplementationEventEntry> snapshot() {
        return List.copyOf(entries);
    }

    public Path writePlanningArtifact(String fileName, String content) {
    ...
    public Path writeAttemptScopedPlanningArtifact(String fileName, int attempt, String content) {
        if (fileArtifactStore == null || runRecord == null || fileName == null || fileName.isBlank()
                || content == null || content.isBlank()) {
            return null;
        }
    ...
    public Path appendSyntaxRepairFailureArtifact(
            Path relativePath,
            String unitLabel,
            String evidence,
            String content
