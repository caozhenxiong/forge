 ...
 */
public class ImplementationSnapshotAssembler {
    ...
    public ImplementationSnapshotAssembler(
    ...
    public ImplementationRuntimeSnapshot buildSnapshot(
            ImplementationPlan plan,
            List<SubtaskExecutionReport> reports,
            List<ImplementationEventEntry> events,
            String note,
    ...
    public ImplementationExecutionBundle buildBundle(ImplementationRuntimeSnapshot snapshot) {
