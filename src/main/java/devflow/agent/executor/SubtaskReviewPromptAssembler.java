 ...
 */
final class SubtaskReviewPromptAssembler {
    ...
    String systemPrompt() {
        return """
                ...
                2. 必须先区分“当前负责能力”和“后续负责能力”。后续负责能力只能记为 deferred，不得拿来阻塞当前子任务。
                3. 只有当前负责能力、当前验收标准和当前修复要求未满足时，才可以拒绝当前子任务。
                4. 对于已经明确留给后续子任务的能力缺口，只能在 summary/evidence 中记录为待后续完成，不能写成当前子任务失败理由。
    ...
    String renderBulletList(List<String> values) {
