...
final class PatchVerifier {
    ...
    PatchVerifier(TreeSitterSupport treeSitterSupport, GeneratedContentGate generatedContentGate) {
        this.treeSitterSupport = treeSitterSupport;
        this.generatedContentGate = generatedContentGate;
    }

    ToolResult verifyInlineScript(Path hostRelativePath, String scriptContent) {
    ...
    ToolResult verifyInlineStyle(Path hostRelativePath, String styleContent) {
    ...
    ToolResult verifyCodeFile(Path projectPath, Path relativePath, String mergedContent) {
