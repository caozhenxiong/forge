 ...
 */
public final class FocusedRegionHtmlPatchExecutor {
    ...
    public FocusedRegionHtmlPatchExecutor(
    ...
    public String generate(HtmlTargetedRewriteRequest request, HtmlEditRegion preferredRegion) {
