 ...
 * 3. 文件级事务写盘。
 */
public final class EmbeddedPatchExecutor {
    ...
    public <T extends EmbeddingEditPlan> GeneratedFileOutput generate(
    ...
    public GeneratedFileOutput externalizeExistingScript(
