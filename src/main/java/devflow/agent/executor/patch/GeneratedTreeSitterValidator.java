 ...
 */
public final class GeneratedTreeSitterValidator {

    private final TreeSitterSupport treeSitterSupport;

    public GeneratedTreeSitterValidator(TreeSitterSupport treeSitterSupport) {
        this.treeSitterSupport = treeSitterSupport;
    }

    public GeneratedContentValidationFailure validate(Path relativePath, String content) {
