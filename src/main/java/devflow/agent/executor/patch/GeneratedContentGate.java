 ...
 */
public class GeneratedContentGate implements DeterministicGate<GeneratedContentGateInput> {
    ...
    public GeneratedContentGate(FileProjectWorkspace workspace, TreeSitterSupport treeSitterSupport) {
    ...
    public GenerationFailureType failureTypeFor(GateReport report) {
    ...
    public ToolFailureCode toolFailureCodeFor(GateReport report) {
        if (report == null || report.passed() || report.issues().isEmpty()) {
    ...
    public String renderFailure(GateReport report) {
