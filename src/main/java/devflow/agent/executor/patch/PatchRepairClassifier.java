 ...
 */
public final class PatchRepairClassifier {

    public PatchFailureClass classify(PatchFailure failure) {
        if (failure == null) {
    ...
    public boolean supportsJsonRepair(Exception exception) {
    ...
    public boolean supportsSyntaxRepair(PatchFailure failure) {
    ...
    public boolean supportsExactReplaceSemanticRepair(PatchFailure failure) {
