 ...
 */
public final class CodePatchFeedbackRenderer {
    ...
    public static String abortFeedback(Path relativePath, EditUnit unit) {
        return """
                - 来源文件: %s
                - 编辑单元: %s
                - 问题: 当前单元输出被截断
    ...
    public static String truncationRetryFeedback(int attempt, Path relativePath, EditUnit unit) {
        return """
                - attempt: %d
                - 文件: %s
                - 编辑单元: %s
    ...
    public static String invalidJsonFeedback(int attempt, Path relativePath, EditUnit unit) {
        return """
                - attempt: %d
                - 文件: %s
                - 编辑单元: %s
    ...
    public static String patchSchemaFeedback(int attempt, Path relativePath, EditUnit unit) {
    ...
    public static String scopeViolationFeedback(int attempt, Path relativePath, EditUnit unit) {
        String strictSingleSymbolAdvice = strictSingleSymbolAdvice(unit);
        return """
                - attempt: %d
                - 文件: %s
    ...
    public static String symbolNotFoundFeedback(int attempt, Path relativePath, EditUnit unit, String evidence) {
        return """
                - attempt: %d
                - 文件: %s
                - 编辑单元: %s
    ...
    public static String generationFailureAdvice(GenerationFailureType failureType) {
