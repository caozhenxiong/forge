 ...
 * 这层把这些纯协议清洗逻辑从协调器中抽离。
 */
public final class GeneratedPayloadSupport {

    private final StructuredPayloadReader structuredPayloadReader;

    public GeneratedPayloadSupport(StructuredPayloadReader structuredPayloadReader) {
        this.structuredPayloadReader = structuredPayloadReader;
    }

    public String normalizeGeneratedPayload(Path relativePath, String content) {
    ...
    public <T> T readStructuredPayload(String generated, Class<T> type) {
