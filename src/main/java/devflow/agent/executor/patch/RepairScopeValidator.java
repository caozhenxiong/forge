 ...
 */
public final class RepairScopeValidator {

    private final PatchContextBuilder patchContextBuilder;

    public RepairScopeValidator(PatchContextBuilder patchContextBuilder) {
        this.patchContextBuilder = patchContextBuilder;
    }

    public ToolResult verifyCodeFile(Path relativePath, String baselineContent, String repairedContent, EditUnit unit) {
    ...
    public ToolResult verifyInlineScript(Path hostRelativePath, String baselineContent, String repairedContent, EditUnit unit) {
        return verifyRestrictedScope(
                hostRelativePath,
                unit,
    ...
    public ToolResult verifyInlineStyle(Path hostRelativePath, String baselineContent, String repairedContent, EditUnit unit) {
        return verifyRestrictedScope(
                hostRelativePath,
                unit,
