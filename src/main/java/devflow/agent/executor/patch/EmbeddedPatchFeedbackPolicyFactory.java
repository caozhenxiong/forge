 ...
 */
public final class EmbeddedPatchFeedbackPolicyFactory {

    public PatchAttemptFeedbackPolicy create(Path relativePath, EditUnit unit, EmbeddedPatchKind patchKind) {
