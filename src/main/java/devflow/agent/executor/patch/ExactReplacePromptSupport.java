 ...
 * 3. 协议字段与公共规则。
 */
public final class ExactReplacePromptSupport {
    ...
    public static FileStateSnapshot capture(String targetPath, String currentContent) {
        return FILE_STATE_LEDGER.capture(java.nio.file.Path.of(targetPath), currentContent);
    }

    public static String renderCurrentContent(String currentContent) {
    ...
    public static String exactReplaceProtocol(String contentName) {
        return """
