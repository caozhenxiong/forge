 ...
 */
final class ImplementationDiagnosticLedger {

    private final ArrayList<ImplementationDiagnosticRecord> records;

    ImplementationDiagnosticLedger() {
        this(List.of());
    }

    ImplementationDiagnosticLedger(List<ImplementationDiagnosticRecord> records) {
        this.records = new ArrayList<>(records == null ? List.of() : records);
    }

    ImplementationDiagnosticLedger copy() {
    ...
    void restore(ImplementationDiagnosticRecord record) {
        if (record != null) {
            records.add(record);
        }
    }

    List<ImplementationDiagnosticRecord> records() {
