...
public final class TestPlanningPolicy {
    ...
    private static final String DELAYED_OBSERVATION_WAIT_MS_KEY = "devflow.test-planning.delayed-observation-wait-ms";
    ...
    public static int delayedObservationWaitMs() {
        return readPositiveInt(
                DELAYED_OBSERVATION_WAIT_MS_KEY,
                DEFAULT_DELAYED_OBSERVATION_WAIT_MS
        );
    }

    public static int observationWaitMs(TestObservationTrigger trigger) {
