...
final class SyntaxRepairTurn {
    ...
    SyntaxRepairTurn(LlmProvider llmProvider, PatchRepairSettings settings) {
        this.llmProvider = llmProvider;
        this.settings = settings;
    }

    String repair(Path relativePath, EditUnit unit, String content, String evidence) {
        String userPrompt = """
                文件：%s
                编辑单元：%s
                允许符号：%s
