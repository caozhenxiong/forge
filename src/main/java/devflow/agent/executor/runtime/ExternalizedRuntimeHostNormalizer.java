 ...
 */
public final class ExternalizedRuntimeHostNormalizer {

    public String normalize(Path relativePath, HtmlRuntimeOwnershipContract runtimeContract, String html) {
